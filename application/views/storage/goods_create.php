<section class="content-header">
    <h1>Создать инвентарь<small></small></h1>
</section>
...
<div class="row">
    ...
    <?endif;?>
		<div class="box box-success">
            <div class="box-body">
             <form role="form" method="post"   class="form-horizontal formself" data-toggle="validator" action="<?php echo base_url('storage/goods_create_action');?>">

	        		<div class="form-group">
				  			<label  class="control-label col-md-2">Название*</label>
				  	<div class="col-md-6">
				  		<input type="text" name="title" class="form-control" data-error="Поле не может быть пустым" required>
					...
					<div class="form-group">
					  	...
					  	<div class="col-md-4">
					  		...
					  		<input   pattern="[0-9]+([\.,][0-9]+)?" name="price" data-error="Неверный формат" class="form-control">
					  			<div class="help-block with-errors"></div>
					  	</div>
