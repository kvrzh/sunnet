<section class="content-header">
    <h1>Добавить Вендор оборудования<small></small></h1>
</section>
...
<div class="row">
    ...
    <?endif;?>
		<div class="box box-success">
            <div class="box-body">
             <form role="form" method="post" class="form-horizontal" action="<?php echo base_url('equipment/equipment_vendor_create');?>">
